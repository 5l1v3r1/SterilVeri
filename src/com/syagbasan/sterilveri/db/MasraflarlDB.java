...
public class MasraflarlDB {

	public static final String KEY_ROWID = "_idRow";
	
	public static final String KEY_DATE = "tarih";
	public static final String KEY_HOSPITAL = "aciklama";
	public static final String KEY_AMOUNT = "masraf_miktari";
	
	private static final String DATABASE_NAME = "MasraflarDB";
	private static final String DATABASE_TABLE = "MasraflarTable";
	...
	public MasraflarlDB(Context c){
		ourContext = c;
	}
	public MasraflarlDB open() throws SQLException{
	...
	public long createEntry(String date, String person, String amount) {
		// TODO Auto-generated method stub
    ...
    public long updateEntry(String date, String person, String amount, String id) {
	...
	public String getAllData() {
		...
		for(c.moveToFirst(); !c.isAfterLast(); c.moveToNext()){
			result = result + c.getString(iRaw) + " " + c.getString(iName)+ "" + c.getString(iUrl)+ "" + c.getString(iDrawable) + "\n";
		}
		return result;
	}
