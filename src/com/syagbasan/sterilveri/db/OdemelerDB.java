...
public class OdemelerDB {
	...
	public static final String KEY_AMOUNT = "odeme_miktari";
	
	private static final String DATABASE_NAME = "OdemelerDB";
	private static final String DATABASE_TABLE = "OdemelerTable";
	...
	public OdemelerDB(Context c){
		ourContext = c;
	}
	public OdemelerDB open() throws SQLException{
