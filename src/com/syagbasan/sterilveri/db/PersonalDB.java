...
public class PersonalDB {
	...
	public static final String KEY_PERSON = "satilan_kisi";
	public static final String KEY_PRODUCT = "satilan_urun";
	public static final String KEY_AMOUNT = "satis_miktari";
	
	private static final String DATABASE_NAME = "PersonalDB";
	private static final String DATABASE_TABLE = "PersonalTable";
