...
public class CustomListViewAdapterFour extends ArrayAdapter<RowItemFour> {
 
    Context context;
 
    public CustomListViewAdapterFour(Context context, int resourceId,
            List<RowItemFour> items) {
    ...
    private class ViewHolder {
        ...
        TextView txtTarih;
        TextView txtSatilanUrun;
    }
     
    @SuppressLint("InflateParams")
	public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder = null;
        RowItemFour rowItem = getItem(position);
         
        LayoutInflater mInflater = (LayoutInflater) context
                .getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.content_list_item2, null);
            ...
            holder.txtSatilanUrun = (TextView) convertView.findViewById(R.id.tvSatilanUrun);
        ...
        holder.txtSatilanUrun.setText(rowItem.getProduct());
        return convertView;
    }
}