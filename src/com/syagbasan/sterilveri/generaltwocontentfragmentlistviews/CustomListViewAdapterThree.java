...
public class CustomListViewAdapterThree extends ArrayAdapter<RowItemThree> {
 
    Context context;
 
    public CustomListViewAdapterThree(Context context, int resourceId,
            List<RowItemThree> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        RowItemThree rowItem = getItem(position);
         
        LayoutInflater mInflater = (LayoutInflater) context
                .getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.content_list_item3, null);
