...
public class CustomListViewAdapterContentConfigDetails extends ArrayAdapter<RowItemContentConfigDetails> {
 
    Context context;
 
    public CustomListViewAdapterContentConfigDetails(Context context, int resourceId,
            List<RowItemContentConfigDetails> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        RowItemContentConfigDetails rowItem = getItem(position);
         
        LayoutInflater mInflater = (LayoutInflater) context
                .getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.content_list_item_details3, null);
